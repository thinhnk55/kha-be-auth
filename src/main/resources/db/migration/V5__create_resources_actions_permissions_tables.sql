...
CREATE TABLE IF NOT EXISTS permissions (
    ...
    CONSTRAINT uq__permissions__role_id__resource_id__action_id
        UNIQUE (role_id, resource_id, action_id)
);

CREATE INDEX IF NOT EXISTS idx__permissions__role_id
    ON permissions (role_id);
CREATE INDEX IF NOT EXISTS idx__permissions__resource_id
    ON permissions (resource_id);
CREATE INDEX IF NOT EXISTS idx__permissions__action_id
